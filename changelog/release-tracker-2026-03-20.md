...
#### Title
Local workspaces move under Redrob Work server control

#### One-line summary
Shifts local workspace ownership into Redrob Work server so creation, reconnects, config writes, and starter bootstrap stay aligned across the app.

#### Main changes
- Local workspace create, rename, delete, config writes, and reload events now go through Redrob Work server first.
...
#### Major bug fix details
- Fixed local workspace reconnect and onboarding inconsistencies by moving workspace ownership into Redrob Work server.
...
#### Title
Team template sharing reaches Redrob Work Cloud
...
#### Release importance
Major release: adds substantial new Cloud collaboration and organization-management workflows that materially change how teams use Redrob Work.
...
#### Major improvement details
- Added Cloud team template sharing flows in the Redrob Work app.
...
#### Title
Redrob Work resumes where you left off
...
- Moved Redrob Work tokens off CLI args and logs, stopped auto-creating Welcome, and fixed collapsed sidebar session lists.
...
- Fixed bundle fetch routing so publish and fetch traffic stays pinned to the configured Redrob Work publisher.
...
#### Main changes
- Added an Redrob Work Cloud skills catalog to the Skills page, with install and share-to-team flows.
...
#### Major improvement details
- Added the Redrob Work Cloud team skills catalog on the app Skills page.
