...
- Cloud workspaces gained a status and version overlay with one-click update, boot states took over the main area, and the Redrob Work Models startup dialog became a quiet inline hint.
