...
/**
 * @param {import("@redrob/types/connect-link").ConnectLinkClaims} claims
 * @returns {string | null}
 */
 ...
 * @returns {import("@redrob/types/connect-link").ConnectLinkClaims | null}
 */
...
/**
 * Extracts the signed token from a connect deep link. Accepts the redrob
 * and redrob-dev schemes and both authority forms (redrob://connect and
 * redrob:///connect).
 *
 * @param {string} rawUrl
 * @returns {string | null}
...
export function extractConnectLinkToken(rawUrl) {
  ...
  if (parsed.protocol !== "redrob:" && parsed.protocol !== "redrob-dev:") return null;
 ...
 *   allowInsecureLoopback?: boolean,
 * }} options
 * @returns {Promise<import("@redrob/types/connect-link").ConnectLinkVerifyResult>}
 */
