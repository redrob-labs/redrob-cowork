...
export type RedrobDesktopTelemetry = {
...
declare global {
  ...
  // The standalone redrob-server package leaves this unset.
  var __redrobDesktopTelemetry: RedrobDesktopTelemetry | undefined;
}
...
export function captureServerException(error: unknown, context: ServerTelemetryContext = {}): boolean {
  ...
  return globalThis.__redrobDesktopTelemetry?.captureException(error, {
    surface: "server",
    ...telemetryContext,
  }) ?? false;
}
