...
function cloudHealth(usable: boolean): RedrobCloudMcpHealth {
  return {
    ...
    desired: { present: true, name: "redrob-cloud", revision: "rev", config: null, token: { present: true, metadata: {} } },
    ...
    tools: {
      ...
      present: usable ? ["redrob-cloud_search_capabilities", "redrob-cloud_execute_capability", "other_tool"] : ["redrob-cloud_search_capabilities"],
