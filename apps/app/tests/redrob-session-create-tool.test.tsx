...
import { RedrobWorkSessionCreateTool } from "../src/components/tools/redrob-session-create";
...
function sessionCreatePart(): DynamicToolUIPart {
  return {
    type: "dynamic-tool",
    toolName: "redrob_session_create",
...
describe("RedrobWorkSessionCreateTool", () => {
  test("renders named created-chat rows with an Open chat action for each session", () => {
    ...
    expect(html).toContain("data-redrob-session-create-card");
