...
const originalElectronBridge = typeof window === "undefined" ? undefined : (window as Window).__REDROB_ELECTRON__;
...
describe("Automation desktop runner presence client", () => {
  beforeEach(() => {
    ...
    if (typeof window !== "undefined") (window as Window).__REDROB_ELECTRON__ = undefined;
  });
  afterEach(() => {
    Object.defineProperty(globalThis, "fetch", { configurable: true, value: originalFetch });
    if (typeof window !== "undefined") (window as Window).__REDROB_ELECTRON__ = originalElectronBridge;
  });
