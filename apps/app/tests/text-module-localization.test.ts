...
const ALLOWED = new Set<string>([
  ...
  "Create or select a Redrob Cowork built-in browser tab, navigate it to a URL, and return the CDP handle for browser automation.",
  ...
  "Help me outline the next Redrob Cowork task.",
  "No available connected model found for eval recovery.",
  "No session is selected.",
  "Open the Redrob Cowork feedback surface from the status menu.",
  ...
  "Session id from the Redrob Cowork context resources or conversation tabs.",
