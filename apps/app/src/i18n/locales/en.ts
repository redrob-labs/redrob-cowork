...
export default {
  ...
  "app.skills_hint_readonly": "Redrob Work server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "composer.connect_skill_prompt": "Use the \"{name}\" skill from the \"{marketplace}\" marketplace. Find it with redrob-cloud_search_capabilities, then call redrob-cloud_execute_capability with the exact capability name \"{capability}\", follow the returned skill content, and use it to ",
  ...
  "connect.connected_to_cloud": "Connected to Redrob Work Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Redrob Work agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Redrob Work agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Redrob Work agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Redrob Work agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "Redrob Work Cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "Redrob Work Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global Redrob Work Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Redrob Work-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single Redrob Work Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_redrob_client": "Redrob Work client",
  "connect.diagnostics_owner_redrob_server": "Redrob Work server",
  "connect.diagnostics_owner_redrob_support": "Redrob Work support",
  ...
  "connect.diagnostics_configured_agent": "Configured Redrob Work agent",
  "connect.diagnostics_effective_agent": "Effective Redrob Work agent",
  "connect.diagnostics_agent_state": "Redrob Work agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote Redrob Work workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace Redrob Work Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Redrob Work Den.",
  ...
  "connect.pitch_title": "Connect is the new way Redrob Work lets you share workflows with your team.",
  ...
  "connect.state_not_configured_action": "Sign in to Redrob Work Cloud to finish setup.",
  ...
  "connect.state_unavailable_action": "Restart Redrob Work. If this continues, run diagnostics.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Redrob Work servers.",
  ...
  "config.server_needed_hint": "Redrob Work server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Redrob Work server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Redrob Work server",
  ...
  "config.server_sharing_title": "Redrob Work server sharing",
  "config.server_url_hint": "Use the URL shared by your Redrob Work server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Redrob Work server URL",
  "config.server_url_label": "Redrob Work Server URL",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Redrob Work worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Redrob Work worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an Redrob Work server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Redrob Work server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Redrob Work worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Redrob Work and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Redrob Work will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs Redrob Work server",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access Redrob Work Cloud.",
  "den.cloud_section_title": "Redrob Work Cloud",
  "den.cloud_sleep_hint": "Sign in to Redrob Work Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Redrob Work Cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "Redrob Work Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Redrob Work Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid Redrob Work sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Redrob Work Cloud sign-in.",
  ...
  "den.error_signout_failed": "Could not sign out of Redrob Work Cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an redrob://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into Redrob Work automatically, paste the sign-in link or one-time code from Redrob Work Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "redrob://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Redrob Work Cloud",
  "den.signing_in": "Finishing Redrob Work Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect Redrob Work.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the Redrob Work link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Redrob Work.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the Redrob Work link, then paste it below.",
  "den.status_cloud_signed_in_as": "Connected Redrob Work Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Redrob Work Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your Redrob Work Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Redrob Work is using the default Cloud control plane.",
  ...
  "extensions.create_skill_hint": "Saved to your organization Library. Agents can load these instructions from Redrob Work Cloud.",
  ...
  "extensions.add_sign_in_required": "Sign in to Redrob Work Cloud to add items to Library.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the Redrob Work app.",
  ...
  "extensions.add_unauthorized": "Your Redrob Work Cloud session expired. Sign in again, then create the skill.",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the Redrob Work Cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to Redrob Work Cloud from Account to see yours.",
  ...
  "extensions.marketplace_description": "Browse Redrob Work built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through Redrob Work Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "Redrob Work Cloud",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Redrob Work can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.name_reserved_redrob_connect": "This name is reserved for Redrob Work Connect. Choose a different name for the workspace MCP.",
  ...
  "mcp.quick_connect_redrob_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_redrob_cloud_title": "Redrob Work Cloud Control",
  ...
  "notifications.empty_hint": "Updates from Redrob Work Cloud and your workspaces will show up here.",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Redrob Work will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Redrob Work server URL.",
  "welcome.organization_server_link": "Using Redrob Work on-premises?",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. Redrob Work will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like an Redrob Work invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid Redrob Work organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "Redrob Work could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: invite links, install links, server URLs, “server token”, redrob://den-auth links, or a raw sign-in code.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. Redrob Work now points at {host} and is ready when you come back.",
  ...
  "settings.organization_server_default": "Using standard Redrob Work Cloud.",
  "settings.organization_server_desc": "Point Redrob Work at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Redrob Work server URL. Saving signs you out so Redrob Work can re-hydrate against that server.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Redrob Work server.",
  "settings.reconnected": "Reconnected to Redrob Work server.",
  ...
  "settings.restart_blocked_message": "The update is ready, but Redrob Work will wait until your active tasks finish before restarting. You can also stop them manually.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Redrob Work will use after local overrides and bootstrap files are applied.",
  "settings.server_endpoints_local_dev": "Local dev server",
  "settings.server_endpoints_mismatch": "Doesn't match API endpoint",
  "settings.server_endpoints_not_configured": "No redrob-cloud MCP entry configured",
  ...
  "settings.tab_connect": "Redrob Work Connect",
  ...
  "memory.sign_in_hint": "Sign in to your Redrob Work account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Redrob Work {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.updates_desc": "Keep Redrob Work up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an Redrob Work host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Redrob Work server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Redrob Work Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Redrob Work Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Redrob Work Cloud opens in your browser. Return here after signing in.",
  ...
  "status.redrob_ready": "Redrob Work Ready",
