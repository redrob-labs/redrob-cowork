...
const en = {
  ...
  "mcp.toggle_requires_server": "Connect to an Redrob Work server to enable or disable MCPs.",
  ...
  "welcome.redrob_key_subtitle": "Get your API key from console.redrob.ai and paste it to power your tasks.",
  ...
  "settings.nuke_confirmation_hint": "Redrob Work will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.open_deeplink_desc": "Paste an Redrob Work deeplink or share URL to open it.",
