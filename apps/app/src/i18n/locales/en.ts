...
export default {
  ...
  "connect.diagnostics_owner_openwork_client": "Redrob Work client",
  "connect.diagnostics_owner_openwork_server": "Redrob Work server",
  "connect.diagnostics_owner_openwork_support": "Redrob Work support",
  ...
  "mcp.name_reserved_openwork_connect": "This name is reserved for Redrob Work Connect. Choose a different name for the workspace MCP.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "Redrob Work Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the Redrob Work app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "Redrob Work UI Control",
  ...
  "join_org.openwork_cloud": "Redrob Work Cloud",
  ...
  "session.share_openwork_workers_only": "Share service links are available for Redrob Work workers.",
  ...
  "settings.debug_openwork_server_version": "Redrob Work server: {version}",
  ...
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's Redrob Work state (.opencode/openwork) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  ...
  "settings.openwork_config_sidecar_desc": "Local Redrob Work server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "Redrob Work server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "Redrob Work server",
  ...
  "settings.reset_openwork_title": "Reset Redrob Work + OpenCode state",
  ...
  "settings.restart_openwork_server": "Restart Redrob Work server",
  ...
  "status.openwork_ready": "Redrob Work Ready",
