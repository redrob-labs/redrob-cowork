 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Redrob Work) are NOT translated
 */
...
const en = {
  ...
  "mcp.oauth_secret_warning": "Redrob Work encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "settings.custom_binary_hint": "Use this to point Redrob Work at a local OpenCode build",
  ...
  "settings.debug_execution_title": "OpenCode execution",
  ...
  "settings.runtime_config_one_writer_rule": "Redrob Work writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.opencode_config_sources_desc": "Inspect what Redrob Work controls at runtime versus what belongs to your workspace config. This works through the Redrob Work server and does not require the OpenCode engine to be healthy.",
  "settings.opencode_config_sources_title": "OpenCode config sources",
  "settings.opencode_source_breakdown_desc": "OpenCode also reads its own project and global config files. Redrob Work injects the runtime config separately; for Redrob Work-managed keys, the injected config is the source to inspect.",
  "settings.opencode_source_breakdown_title": "OpenCode source breakdown",
  "settings.runtime_database_title": "Runtime database",
  "settings.runtime_db_json_title": "Runtime DB JSON",
  "settings.source_global_opencode_desc": "User-level OpenCode config under ~/.config/opencode.",
  "settings.source_global_opencode_title": "Global opencode config",
  "settings.source_injected_config_desc": "The object Redrob Work injects into OpenCode at runtime.",
  "settings.source_injected_config_title": "Redrob Work injected config",
  "settings.source_project_opencode_desc": "Workspace-level OpenCode config owned by the user/project.",
  "settings.source_project_opencode_title": "Project opencode config",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Redrob Work. Off by default.",
  ...
  "settings.nuke_dialog_desc": "This removes local Redrob Work, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Redrob Work.",
  ...
  "settings.redrob_config_sidecar_desc": "Local Redrob Work server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  ...
  "settings.reset_redrob_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside redrob-dev-data.",
  "settings.reset_redrob_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside redrob-dev-data.",
  "settings.reset_redrob_title": "Reset Redrob Work + OpenCode state",
  ...
  "settings.environment.footer_hint": "REDROB_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  ...
  "settings.environment.validation_reserved": "REDROB_ and OPENCODE_ names are managed by Redrob Work/OpenCode.",
  ...
  "system.reload_body_default": "Redrob Work detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Redrob Work detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "hero.suggestion_week_description": "Pull highlights from email and calendar.",
  "hero.suggestion_week_prompt": "Summarize my week: pull the highlights from my connected email and calendar and give me a short digest of what happened and what needs my attention.",
  "hero.suggestion_week_title": "Summarize my week",
  ...
  "skills.status_opencode_unavailable": "OpenCode client unavailable.",
