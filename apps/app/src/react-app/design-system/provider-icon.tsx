  ...
  return (
    ...
    >
      {isOpenAI ? (
        ...
        // The Claude sunburst, not Anthropic's "A" wordmark. These rows name models
        // (`claude-opus-5`), and a company mark beside a product name reads as the wrong
        // logo -- the same reason an OpenAI row shows the OpenAI mark and not "Microsoft".
        <svg
          role="img"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
          ...
          height={size}
        >
          <path d="M12 1.5a.6.6 0 0 1 .6.6v5.2a.6.6 0 0 1-1.2 0V2.1a.6.6 0 0 1 .6-.6Zm0 14.2a.6.6 0 0 1 .6.6v5.2a.6.6 0 0 1-1.2 0v-5.2a.6.6 0 0 1 .6-.6ZM1.5 12a.6.6 0 0 1 .6-.6h5.2a.6.6 0 0 1 0 1.2H2.1a.6.6 0 0 1-.6-.6Zm14.2 0a.6.6 0 0 1 .6-.6h5.2a.6.6 0 0 1 0 1.2h-5.2a.6.6 0 0 1-.6-.6ZM4.56 4.56a.6.6 0 0 1 .85 0l3.68 3.68a.6.6 0 1 1-.85.85L4.56 5.41a.6.6 0 0 1 0-.85Zm10.35 10.35a.6.6 0 0 1 .85 0l3.68 3.68a.6.6 0 1 1-.85.85l-3.68-3.68a.6.6 0 0 1 0-.85ZM19.44 4.56a.6.6 0 0 1 0 .85l-3.68 3.68a.6.6 0 1 1-.85-.85l3.68-3.68a.6.6 0 0 1 .85 0ZM9.09 14.91a.6.6 0 0 1 0 .85l-3.68 3.68a.6.6 0 1 1-.85-.85l3.68-3.68a.6.6 0 0 1 .85 0Z" />
        </svg>
      ) : isOpenCode ? (
        <svg
          role="img"
