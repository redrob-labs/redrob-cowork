...
import type { RedrobSessionGroupState } from "@/app/lib/redrob-server";
...
const MIGRATION_PREFIX = "redrob.sessionGroups.migrated.v2";
...
function serverStateFromWorkspaceState(state: WorkspaceGroupState): RedrobSessionGroupState {
  return {
