...
export const openNotificationCenterEvent = "redrob-open-notification-center";

/** Window event that asks the marketplace view to highlight a plugin. */
export const openMarketplacePluginEvent = "redrob-open-marketplace-plugin";

const PENDING_MARKETPLACE_PLUGIN_KEY = "redrob:pending-marketplace-plugin";
...
const ALERT_TOAST_ID = "redrob-notification-alert";
