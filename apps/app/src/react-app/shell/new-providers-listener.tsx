...
const SEEN_KEY = "redrob.seenProviderIds";
const PENDING_MODEL_PICKER_KEY = "redrob.pendingModelPickerProviderIds";
const NEW_PROVIDERS_DEDUPE_KEY = "new-providers";

/** Custom event to request the model picker to open. */
export const openModelPickerEvent = "redrob-open-model-picker";
/** Custom event to request the provider auth (connect API keys) modal to open. */
export const openProviderAuthEvent = "redrob-open-provider-auth";
