...
import { usePublishRedrobContext } from "./control/control-provider";
import { buildRedrobContext } from "./redrob-context-projector";
import { useUiStateStore } from "./ui-state-store";

export function RedrobContextPublisher() {
  ...
  const context = useMemo(() => buildRedrobContext({
    route,
    revision,
  ...
  usePublishRedrobContext(context);
  return null;
}
