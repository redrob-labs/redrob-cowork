...
const SUPPORT_EMAIL = "team@redrob.io";
const SUPPORT_MAILTO = `mailto:${SUPPORT_EMAIL}?subject=Redrob Work%20Den%20remote%20worker%20upgrade`;

/**
 * Small inline link rendered inside the remote-worker error card. When clicked,
 * it opens a dialog explaining the Redrob Work Den upgrade situation and how to
 * reach support.
 */
export function RedrobWorkDenHelpLink() {
  ...
  return (
    <>
      ...
      >
        Using Redrob Work Den Remote Workers? Click here
      </button>

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Redrob Work Den remote workers</DialogTitle>
            <DialogDescription>
              We recently upgraded our servers. If your remote worker was
              provisioned before that upgrade, it may no longer be compatible
              with the current Redrob Work app.
            </DialogDescription>
          </DialogHeader>
