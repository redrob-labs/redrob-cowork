...
The artifact preview keeps **outside-chat Markdown** readable with inline \`surface renderer\`, a fenced code block, and [Redrob Cowork](https://redrob.io).
  ...
  const seedPdfArtifactControlAction = React.useMemo<RedrobControlAction | null>(() => {
    ...
    return {
      ...
      execute: async () => {
        ...
        // Minimal single-page PDF that draws "Redrob Cowork PDF" — base64 encoded.
        const pdfBase64 =
