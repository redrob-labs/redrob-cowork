import type { RedrobSessionMessage } from "@/app/lib/redrob-server";
...
function toCacheEntry(updatedAt: number, messages: RedrobSessionMessage[]): CacheEntry {
