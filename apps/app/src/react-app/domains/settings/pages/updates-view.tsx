...
function getReleaseChannelOptions(): { label: string; value: ReleaseChannel }[] {
  return [
    { label: t("settings.release_channel_stable"), value: "stable" },
    { label: t("settings.release_channel_alpha"), value: "alpha" },
  ];
}
      ...
      {props.webDeployment ? (
        ...
        <Separator />
          {props.alphaChannelSupported && props.releaseChannel ? (
            <LayoutSectionItem>
              <LayoutSectionItemHeader>
                <LayoutSectionItemTitle>{t("settings.release_channel_title")}</LayoutSectionItemTitle>
                <LayoutSectionItemDescription>
                ...
                <LayoutSectionItemHeaderActions>
                  <Select
                    ...
                    items={getReleaseChannelOptions()}
                    onValueChange={(value) => {
                  ...
                  >
                    <SelectTrigger aria-label={t("settings.release_channel_title")} className="w-48">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectGroup>
                        {getReleaseChannelOptions().map((option) => (
