...
const workspaceCards: SettingsCardDefinition[] = [
  { tab: "preferences", icon: Cog, titleKey: "settings.tab_preferences", descKey: "settings.general_card_desc_preferences" },
  { tab: "permissions", icon: FolderLock, titleKey: "settings.tab_permissions", descKey: "settings.general_card_desc_permissions" },
  { tab: "advanced", icon: Wrench, titleKey: "settings.tab_advanced", descKey: "settings.general_card_desc_advanced" },
];

const globalCards: SettingsCardDefinition[] = [
  { tab: "ai", icon: Sparkles, titleKey: "settings.tab_ai", descKey: "settings.general_card_desc_ai" },
  { tab: "appearance", icon: Paintbrush, titleKey: "settings.tab_appearance", descKey: "settings.general_card_desc_appearance" },
  { tab: "environment", icon: Terminal, titleKey: "settings.tab_environment", descKey: "settings.general_card_desc_environment" },
  { tab: "updates", icon: RefreshCcw, titleKey: "settings.tab_updates", descKey: "settings.general_card_desc_updates" },
  { tab: "recovery", icon: ShieldCheck, titleKey: "settings.tab_recovery", descKey: "settings.general_card_desc_recovery" },
];
