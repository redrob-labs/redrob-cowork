...
export function blueprintSessions(config: WorkspaceRedrobConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceRedrobConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceRedrobConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceRedrobConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceRedrobConfig>)
      : {};
