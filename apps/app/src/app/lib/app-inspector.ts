 ...
 *
 * Consumers read via `window.__redrob` from a devtools console or from
...
declare global {
  ...
  var __redrob: InspectorAPI | undefined;
}
...
function installIfNeeded() {
  ...
  Object.defineProperty(window, "__redrob", {
    value: api,
    configurable: true,
    writable: false,
  });
...
export function recordInspectorEvent(name: string, data?: unknown) {
  installIfNeeded();
  window.__redrob?.record(name, data);
}
