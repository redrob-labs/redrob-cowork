...
export const STABLE_UPDATER_ENDPOINT =
  "https://github.com/redrob-labs/redrob-work/releases/latest/download/latest.json";

/** Alpha channel's Tauri updater manifest URL (macOS-only, rolling). */
export const ALPHA_UPDATER_ENDPOINT =
  "https://github.com/redrob-labs/redrob-work/releases/download/alpha-macos-latest/latest.json";
