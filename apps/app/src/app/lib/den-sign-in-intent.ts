...
const DESKTOP_SIGN_IN_STARTED_AT_KEY = "redrob.den.desktopSignInStartedAt";
const ORG_SELECTION_PENDING_KEY = "redrob.den.orgSelectionPendingAt";
const ORG_SELECTION_SUGGESTION_KEY = "redrob.den.orgSelectionSuggestion";
