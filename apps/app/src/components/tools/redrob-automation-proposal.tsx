...
/**
 * Reads an `automation.propose` affordance result out of an redrob_execute
...
export function isAutomationProposalToolPart(part: DynamicToolUIPart): boolean {
  return part.toolName === "redrob_execute"
    && part.state === "output-available"
    && parseAutomationProposal(part.output) !== null
}

export function RedrobWorkAutomationProposalTool({ part }: { part: DynamicToolUIPart }) {
  ...
  const blocker = !automationsEnabled
    ...
    : !signedIn
      ? "Sign in to Redrob Work Cloud to create this Automation."
      : null
  ...
  return (
    <div
      ...
      data-redrob-automation-proposal
