...
SNAPSHOT_NAME="${1:-${DAYTONA_SNAPSHOT_NAME:-redrob-runtime}}"
...
LOCAL_IMAGE_TAG="${DAYTONA_LOCAL_IMAGE_TAG:-redrob-daytona-snapshot:${SNAPSHOT_NAME//[^a-zA-Z0-9_.-]/-}}"
...
echo "- redrob-server@$REDROB_SERVER_VERSION" >&2
