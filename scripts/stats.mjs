...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "redrob-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "redrob-labs/redrob-work"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "redrob-download-stats",
  }
