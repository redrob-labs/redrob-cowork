...
test("waitFor appends a bounded on-screen dump to timeout failures", async () => {
  ...
  await assert.rejects(
    ...
    /On screen: \{"hash":"#\/workspace\/demo\/extensions","route":"\/workspace\/demo\/extensions","title":"Redrob Work","buttons":\["Back","Add extension"\],"body":"Extensions Add an extension to this workspace"\}/,
  );
});
