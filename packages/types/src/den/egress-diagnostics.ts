...
export const EGRESS_DIAGNOSTIC_RUN_HEADER = "x-redrob-diagnostic-run-id"
export const EGRESS_DIAGNOSTIC_STEP_HEADER = "x-redrob-diagnostic-step"
export const EGRESS_DIAGNOSTIC_SIGNATURE_HEADER = "x-redrob-diagnostic-signature"
export const EGRESS_DIAGNOSTIC_ID_HEADER = "x-redrob-diagnostic-id"
