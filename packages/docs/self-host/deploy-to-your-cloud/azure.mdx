...
description: "Run Redrob Work on Azure Kubernetes Service with Azure Database for MySQL."
---
...
The Redrob Work chart manages Deployments, Services, ConfigMaps, Secret references, probes, the Ingress, and the database migration Job.
