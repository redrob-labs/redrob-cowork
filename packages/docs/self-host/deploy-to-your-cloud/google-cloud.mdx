...
description: "Run Redrob Work on GKE Autopilot with Cloud SQL for MySQL."
---
...
The Redrob Work chart manages Deployments, Services, ConfigMaps, Secret references, probes, the Ingress, and the database migration Job. GKE `BackendConfig` and `ManagedCertificate` resources are applied alongside the chart.
