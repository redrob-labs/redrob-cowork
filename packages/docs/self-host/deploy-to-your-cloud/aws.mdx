---
title: "Deploy on AWS"
description: "Run Redrob Work on Amazon EKS with Amazon RDS for MySQL."
---
...
The Redrob Work chart manages Deployments, Services, ConfigMaps, Secret references, probes, and the database migration Job.
