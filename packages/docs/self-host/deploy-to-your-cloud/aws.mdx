---
title: "Deploy on AWS"
description: "Run Redrob Cowork on Amazon EKS with Amazon RDS for MySQL."
---
...
The Redrob Cowork chart manages Deployments, Services, ConfigMaps, Secret references, probes, and the database migration Job.
...
For exact CLI commands, values, DNS/TLS choices, migration troubleshooting, verification, and cleanup, follow the [AWS EKS operator runbook](https://github.com/redrob-labs/redrob-work/blob/dev/docs/aws-eks-helm.md).
