...
<Warning>
**Alpha: customer-only access.** OpenWork Web is available only to customers in the alpha. Email [team@redrob.io](mailto:team@redrob.io) to request access. The price is **$50 per hosted instance**.
</Warning>
...
OpenWork Web is enabled per organization. If you do not see it in the sidebar, your organization does not have access yet — email [team@redrob.io](mailto:team@redrob.io) to request it.
