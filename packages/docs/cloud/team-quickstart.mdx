...
Head to [app.redrob.io](https://app.redrob.io). Enter your work email and press **Next** — OpenWork routes you to the right sign-in step automatically.
...
Now switch to the [OpenWork desktop app](https://redrob.io). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.
