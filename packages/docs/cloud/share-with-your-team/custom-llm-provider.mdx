...
description: "Create a custom provider definition in Redrob Work Cloud and import it into the desktop app"
---
...
<Frame>
  ![Custom LLM provider detail in Redrob Work Cloud](/images/cloud-custom-llm-provider-detail.png)
</Frame>
...
```json
{
  ...
  "doc": "https://infron.ai/docs/frameworks-and-integrations/redrob",
...
<Frame>
  ![DeepSeek V3.2 via Infron in the Redrob Work Chat model picker](/images/infron-model-picker.png)
</Frame>

Pick the model and it's live in the session footer:

<Frame>
  ![Infron · DeepSeek V3.2 selected in an Redrob Work session](/images/infron-model-active.png)
</Frame>
