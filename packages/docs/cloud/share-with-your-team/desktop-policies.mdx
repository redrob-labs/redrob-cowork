...
- `Built-in Extensions`: allow or block Redrob Work-provided built-in extensions, including browser, image, and local-provider extensions.
- `Welcome Page`: show or hide the getting-started page for new users.

## Configure a policy

1. Open [app.redrob.io](https://app.redrob.io/) and choose your organization.
