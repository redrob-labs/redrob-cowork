---
title: "Redrob Work MCP for Zed"
sidebarTitle: "Zed"
description: "Zed MCP setup for Redrob Work Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The Redrob Work MCP server ([Redrob Work Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Zed to use the Redrob Work capabilities your organization has made
