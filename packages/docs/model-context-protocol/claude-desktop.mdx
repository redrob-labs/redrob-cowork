---
title: "Redrob Work MCP for Claude Desktop"
sidebarTitle: "Claude Desktop"
description: "Claude Desktop MCP setup for Redrob Work Connect, using custom connectors or mcp-remote to reach your org's shared capabilities."
---

The Redrob Work MCP server ([Redrob Work Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Desktop to use the Redrob Work capabilities your organization has
...
3. Name it `Redrob Work` and set the URL to:
...
```json
{
  "mcpServers": {
    "redrob": {
      "command": "npx",
      "args": ["-y", "mcp-remote@latest", "https://api.redrob.io/mcp/agent"]
    }
  }
}
```
...
Redrob Work accepts. Restart Claude Desktop after editing the config.
