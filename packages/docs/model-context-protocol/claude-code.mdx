---
title: "Redrob Work MCP for Claude Code"
sidebarTitle: "Claude Code"
description: "Claude Code MCP setup for Redrob Work Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared MCP connections, skills, and Cloud resources."
---

The Redrob Work MCP server ([Redrob Work Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Code to use the Redrob Work capabilities your organization has made
...
3. Select `redrob`, then follow the browser sign-in and choose your
   organization.

## Switch organizations

Run `/mcp` inside Claude Code, select `redrob`, then clear or
