---
title: "Redrob Work MCP for Codex"
sidebarTitle: "Codex"
description: "Codex MCP setup for Redrob Work Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The Redrob Work MCP server ([Redrob Work Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Codex to use the Redrob Work capabilities your organization has made
