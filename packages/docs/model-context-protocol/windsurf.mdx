---
title: "Redrob Work MCP for Windsurf"
sidebarTitle: "Windsurf"
description: "Windsurf MCP setup for Redrob Work Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The Redrob Work MCP server ([Redrob Work Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Windsurf to use the Redrob Work capabilities your organization has made
...
Remove the stored MCP auth token for `redrob`, then restart the server and
