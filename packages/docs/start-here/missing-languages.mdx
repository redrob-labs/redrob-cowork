...
description: "See which Redrob Cowork languages ship today and help us improve them."
---

Redrob Cowork already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="Redrob Cowork missing languages overview"
...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/redrob-labs/redrob-work/tree/dev/apps/app/src/i18n/locales).
...
If you want to add a new language to Redrob Cowork, the basic file changes are:
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/redrob-labs/redrob-work/issues/1385).
