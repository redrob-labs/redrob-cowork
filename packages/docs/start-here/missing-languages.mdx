...
description: "See which Redrob Work languages ship today and help us improve them."
---

Redrob Work already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="Redrob Work missing languages overview"
...
If you want to add a new language to Redrob Work, the basic file changes are:
