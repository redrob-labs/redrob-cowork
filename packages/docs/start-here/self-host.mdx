...
Want hosted workspaces, team Collections, or shared providers without running infra? Use [Redrob Work Cloud](/cloud/get-started) instead. Rolling this out across a company? [Book a call](https://calendar.app.google/86QpCENvhfEzDFLu5) about [Enterprise](/cloud/enterprise).
...
If you only need one private remote workspace, deploy the worker runtime. If you want Redrob Work Cloud-style accounts, teams, and organization management, deploy Den web, Den controller, and optionally the inference service.
...
### Redrob Work Cloud and the desktop app

Redrob Work cloud-style self-hosting is composed of three main pieces:
...
Skip the server. [**Redrob Work Cloud**](/cloud/get-started) runs hosted workers for your team.
