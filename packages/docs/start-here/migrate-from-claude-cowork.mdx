...
| Claude-compatible plugins | Plugins | Import the plugin or marketplace manifest; Redrob Work normalizes its skills, commands, and MCP dependencies. |
| MCP servers | Connectors and custom apps | Reconnect the server through Redrob Work Connect or add its URL as a custom app. |
| Claude models | Anthropic provider | Add an Anthropic API key, or provision Anthropic centrally through Redrob Work Cloud. |
...
See [Connectors, skills, and plugins](/start-here/do-work-with-it/skills-plugins-and-mcp) for how Redrob Work organizes these pieces. For team distribution, see [Publish and copy a skill](/start-here/do-work-with-it/publish-and-copy-a-skill).
...
Do not ask every teammate to repeat your local setup by hand. In Redrob Work Cloud, publish approved skills and connections once, assign them to the right teams, and apply desktop policies centrally.
