...
For self-hosted Den origins, set `REDROB_AGENT_DIAGNOSTICS_TRUSTED_ORIGINS` before OpenWork launches:

```bash
REDROB_AGENT_DIAGNOSTICS_TRUSTED_ORIGINS=https://openwork.example.com
```
