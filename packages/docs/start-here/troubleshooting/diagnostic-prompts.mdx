...
5. Find OpenWork's generated `runtime-opencode-config.json` beside the active `server.json`. Respect discovered `REDROB_SERVER_CONFIG`, `REDROB_RUNTIME_DB`, or XDG overrides. Typical locations are:
