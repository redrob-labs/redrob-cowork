...
description: "Choose how organization install links deliver standard Redrob Work desktop installers."
---

Organization install links help members install the standard Redrob Work desktop and connect it to the correct Den organization. Den does not build a customer-specific installer or wrap the installer in a ZIP. The implementation and security details remain in the repository's [Organization Install Links guide](https://github.com/redrob-labs/redrob-work/blob/dev/docs/org-install-links.md#installer-delivery).
