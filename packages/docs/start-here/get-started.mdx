...
Most people should start with the [OpenWork app](https://redrob.io/download). It lets you use your own LLMs, skills, plugins, and MCP servers locally, then add Cloud when your team needs shared management.
...
<CardGroup cols={3}>
  <Card title="Download OpenWork" icon="download" href="https://redrob.io/download">
