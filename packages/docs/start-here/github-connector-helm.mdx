...
description: "Create a GitHub App and configure the Redrob Work EE Helm chart for repository connectors."
---

The GitHub connector lets a self-hosted Redrob Work deployment install a GitHub App, list repositories the installation can read, discover plugin or marketplace manifests, import selected repositories, and keep imported content fresh from GitHub webhooks.
...
The GitHub App needs these Redrob Work URLs:
...
## What Redrob Work does with it

When an admin clicks **Connect GitHub** in Redrob Work:
...
Choose GitHub, install the GitHub App on a test account or organization, select a repository, and start discovery. A working setup should return to Redrob Work, show repositories visible to the installation, and allow discovery on a selected repository.
