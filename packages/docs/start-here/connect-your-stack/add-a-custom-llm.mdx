...
<Note>
**Local provider setup.** A custom provider can stay entirely in your workspace. Redrob Work remains free, and you do not need to sign in to Redrob Work Cloud. For centrally managed team access, see [Adding a managed LLM provider](/cloud/share-with-your-team/managed-llm-provider).
</Note>
...
For teams, manage the provider in Redrob Work Cloud under [Models > Bring your Own Keys](/cloud/share-with-your-team/managed-llm-provider), then make it available from `Settings > Cloud Providers` in the desktop app.
