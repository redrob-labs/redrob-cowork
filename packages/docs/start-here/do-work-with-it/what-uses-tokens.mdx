...
description: "Understand when Redrob Work model usage starts and how to control it."
---

Redrob Work uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
