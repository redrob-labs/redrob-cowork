...
description: "Understand when Redrob Cowork model usage starts and how to control it."
---

Redrob Cowork uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
