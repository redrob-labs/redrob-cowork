...
Reference implementation for server-side remote MCP consumption in Redrob Cowork.
...
not change local/direct engine MCP, the incoming Redrob Cowork Connect meta-MCP,
