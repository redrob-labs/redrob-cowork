...
Desktop app policy config is loaded from Redrob Work Cloud through `GET /v1/me/desktop-config` and exposed inside the desktop app through `DesktopConfigProvider`.
