...
(`apps/server/src/redrob-runtime-config.ts:34-66`) — separate from the existing
...
- **Reference files:** `ee/packages/den-db/src/schema/workers.ts`,
  ...
  `apps/server/src/redrob-runtime-config.ts:34-66`,
...
`~/.agentic-workflow/joi-fairshare-redrob/plans/20260702-112912-memory-bank/consolidated-review.md`.
