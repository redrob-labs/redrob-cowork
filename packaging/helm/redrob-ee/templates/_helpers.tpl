{{- define "redrob-ee.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "redrob-ee.fullname" -}}
...
{{- define "redrob-ee.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "redrob-ee.selectorLabels" -}}
app.kubernetes.io/name: {{ include "redrob-ee.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "redrob-ee.labels" -}}
helm.sh/chart: {{ include "redrob-ee.chart" . }}
{{ include "redrob-ee.selectorLabels" . }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end -}}

{{- define "redrob-ee.componentSelectorLabels" -}}
{{ include "redrob-ee.selectorLabels" .root }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "redrob-ee.componentLabels" -}}
{{ include "redrob-ee.labels" .root }}
app.kubernetes.io/component: {{ .component }}
{{- end -}}

{{- define "redrob-ee.configName" -}}
{{ include "redrob-ee.fullname" . }}-config
{{- end -}}

{{- define "redrob-ee.allowPrivateMcpUrls" -}}
...
{{- define "redrob-ee.secretName" -}}
{{- if .Values.secret.existingSecret -}}
{{- .Values.secret.existingSecret -}}
{{- else -}}
{{- include "redrob-ee.fullname" . }}-secret
{{- end -}}
{{- end -}}

{{- define "redrob-ee.denApiServiceName" -}}
{{ include "redrob-ee.fullname" . }}-den-api
{{- end -}}

{{- define "redrob-ee.denWebServiceName" -}}
{{ include "redrob-ee.fullname" . }}-den-web
{{- end -}}

{{- define "redrob-ee.inferenceServiceName" -}}
{{ include "redrob-ee.fullname" . }}-inference
{{- end -}}

{{- define "redrob-ee.denApiInternalUrl" -}}
{{- default (printf "http://%s:%v" (include "redrob-ee.denApiServiceName" .) .Values.denApi.service.port) .Values.config.internal.apiBaseUrl -}}
{{- end -}}

{{- define "redrob-ee.authFallbackInternalUrl" -}}
{{- default (include "redrob-ee.denApiInternalUrl" .) .Values.config.internal.authFallbackBaseUrl -}}
{{- end -}}

{{- define "redrob-ee.inferenceInternalUrl" -}}
{{- default (printf "http://%s:%v" (include "redrob-ee.inferenceServiceName" .) .Values.inference.service.port) .Values.config.internal.inferenceProxyBaseUrl -}}
{{- end -}}

{{- define "redrob-ee.customCa.mountPath" -}}
/etc/redrob/custom-ca
{{- end -}}

{{- define "redrob-ee.customCa.filePath" -}}
{{ include "redrob-ee.customCa.mountPath" . }}/ca-bundle.pem
{{- end -}}

{{- define "redrob-ee.customCa.validate" -}}
...
{{- define "redrob-ee.customCa.volume" -}}
- name: custom-ca
...
{{- define "redrob-ee.customCa.volumeMount" -}}
- name: custom-ca
  mountPath: {{ include "redrob-ee.customCa.mountPath" . | quote }}
  readOnly: true
{{- end -}}

{{- define "redrob-ee.customCa.env" -}}
- name: NODE_EXTRA_CA_CERTS
  value: {{ include "redrob-ee.customCa.filePath" . | quote }}
{{- end -}}

{{- define "redrob-ee.observabilityBackend" -}}
...
{{- define "redrob-ee.observabilityOtelExporter" -}}
...
{{- define "redrob-ee.observabilityOtelSampler" -}}
...
{{- define "redrob-ee.observabilityEnv" -}}
{{- $root := .root -}}
{{- $serviceName := .serviceName -}}
{{- $backend := include "redrob-ee.observabilityBackend" $root -}}
...
{{- if eq $backend "otel" }}
{{- $otelSampler := include "redrob-ee.observabilityOtelSampler" $otel.tracesSampler -}}
...
- name: OTEL_TRACES_EXPORTER
  value: {{ include "redrob-ee.observabilityOtelExporter" (dict "signal" "traces" "value" $otel.exporters.traces) | quote }}
- name: OTEL_METRICS_EXPORTER
  value: {{ include "redrob-ee.observabilityOtelExporter" (dict "signal" "metrics" "value" $otel.exporters.metrics) | quote }}
- name: OTEL_LOGS_EXPORTER
  value: {{ include "redrob-ee.observabilityOtelExporter" (dict "signal" "logs" "value" $otel.exporters.logs) | quote }}
