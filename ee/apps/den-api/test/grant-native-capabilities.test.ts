...
import { inArray } from "@redrob-ee/den-db/drizzle"
import {
  AuthUserTable,
...
function seedRequiredEnv() {
  process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/redrob_test_grantnative"
