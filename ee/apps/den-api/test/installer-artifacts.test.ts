...
test("builds the installer asset URL for the configured release", () => {
  expect(installerReleaseAssetUrl("redrob-enterprise-mac-arm64-9.9.9.dmg", {
    releaseTag: "v9.9.9+build 2",
    releaseRepo: "redrob-labs/redrob-work",
  })).toBe("https://github.com/redrob-labs/redrob-work/releases/download/v9.9.9%2Bbuild%202/redrob-enterprise-mac-arm64-9.9.9.dmg")
})
...
test("builds the installer asset URL from the resolved default release", async () => {
  ...
  await expect(installerReleaseAssetUrl("redrob-enterprise-win-x64-9.9.9.exe")).resolves.toBe(
    "https://github.com/redrob-labs/redrob-work/releases/download/v9.9.9/redrob-enterprise-win-x64-9.9.9.exe",
  )
})

test.each([
  ["mac-arm64", "v9.9.9", "redrob-mac-arm64-9.9.9.dmg"],
  ["mac-x64", "9.9.9", "redrob-mac-x64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "redrob-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "redrob-linux-x86_64-9.9.9.AppImage"],
  ["linux-arm64", "v9.9.9", "redrob-linux-arm64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "redrob-enterprise-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "redrob-enterprise-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "redrob-enterprise-linux-x86_64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "redrob-cloud-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "redrob-cloud-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "redrob-cloud-linux-x86_64-9.9.9.AppImage"],
...
test("resolves only a mounted installer asset and reports its size", async () => {
  ...
  const fileName = "redrob-enterprise-win-x64-9.9.9.exe"
  ...
  await expect(resolveConfiguredInstallerArtifact("redrob-cloud-win-x64-9.9.9.exe")).resolves.toBeNull()
...
test("ignores a directory with the expected filename", async () => {
  const artifactsDir = mkdtempSync(path.join(os.tmpdir(), "ow-installer-artifacts-"))
  const fileName = "redrob-cloud-win-x64-9.9.9.exe"
