const DEVELOPMENT_CONDITIONS_REEXEC = "REDROB_DEN_DEVELOPMENT_CONDITIONS_REEXEC"
...
if (process.env.REDROB_DEV_MODE === "1" && process.env[DEVELOPMENT_CONDITIONS_REEXEC] !== "1") {
