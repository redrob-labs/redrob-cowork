import { and, desc, eq, isNull } from "@redrob-ee/den-db/drizzle"
import { ArtifactViewRevisionTable, ArtifactViewTable } from "@redrob-ee/den-db/schema"
import { createDenTypeId, normalizeDenTypeId, type DenTypeId } from "@redrob-ee/utils/typeid"
import type { GeneratedArtifactView, GeneratedArtifactViewRevision } from "@redrob/types/workflows"
