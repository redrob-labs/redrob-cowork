...
export const DEFAULT_REDROB_MARKETPLACE_NAME = "Redrob Work Marketplace"
export const DEFAULT_REDROB_MARKETPLACE_DESCRIPTION = "Built-in Redrob Work AI capabilities available in the desktop app after sign-in."
export const DEFAULT_REDROB_MARKETPLACE_LOGO_URL = "/redrob-mark.svg"
