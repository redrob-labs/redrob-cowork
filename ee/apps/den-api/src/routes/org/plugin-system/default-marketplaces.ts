...
export const DEFAULT_REDROB_MARKETPLACE_NAME = "OpenWork Marketplace"
export const DEFAULT_REDROB_MARKETPLACE_DESCRIPTION = "Built-in OpenWork AI capabilities available in the desktop app after sign-in."
export const DEFAULT_REDROB_MARKETPLACE_LOGO_URL = "/openwork-mark.svg"
