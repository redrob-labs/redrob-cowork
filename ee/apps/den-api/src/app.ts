...
import { MemberTable, OrganizationTable } from "@redrob-ee/den-db/schema"
  ...
  app.use(
    "*",
      cors({
        ...
        credentials: true,
        allowHeaders: ["Content-Type", "Authorization", "X-Api-Key", "X-Request-Id", "X-Redrob Work-Legacy-Org-Id", "X-Redrob Work-Org-Id"],
