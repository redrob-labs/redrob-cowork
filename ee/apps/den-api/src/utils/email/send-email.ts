import { EmailSendError, emailSubjects, renderEmailHtml, sendEmail as sendSharedEmail, type EmailTemplate, type SendEmailInput } from "@redrob/email"
...
// Dev/eval-only affordance: when REDROB_DEV_MODE=1, keep the last few
