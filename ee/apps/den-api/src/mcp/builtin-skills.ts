...
name: create-skill
description: |
  Create a new Redrob Work Cloud skill as a plugin with one skill component.
...
Call the direct MCP tool \`create_skill\` (projected as \`redrob-cloud_create_skill\` in Redrob Work Desktop). Do not route this flow through \`execute_capability\` or \`postPlugins\`.
...
Call \`redrob-cloud_execute_capability\` with these names. Skip broad search unless a call returns \`unknown_capability\`.
...
name: share-plugin
description: |
  Share an Redrob Work Cloud skill's plugin with a person, team, or organization.
...
export const BUILTIN_SKILLS: BuiltinSkillDefinition[] = [
  {
    descriptor: {
      name: "create-skill",
      title: "Create Skill",
      description: "Create a new Redrob Work Cloud skill that its creator can use immediately.",
  ...
  },
  {
    descriptor: {
      name: "share-plugin",
      title: "Share Plugin",
      description: "Share an Redrob Work Cloud skill's plugin with a person, team, or organization.",
