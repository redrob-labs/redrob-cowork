...
export default async function DiagnosticsPage({ searchParams }: { searchParams: Promise<{ runId?: string | string[] }> }) {
  ...
  return <main>
    ...
    <header className="hero">
      <div><p className="eyebrow">Redrob Work Enterprise</p><h1>Diagnostics</h1><p>Prove that an enterprise allowlist reaches us, then inspect the client handshake request by request.</p></div>
