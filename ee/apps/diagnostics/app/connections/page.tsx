  ...
  return <article className="incident">
    ...
    <details>
      ...
      <dl className="incident-details">
        ...
        <div><dt>Redrob Work server</dt><dd>{incident.serverVersion ?? "not observed"}</dd></div>
...
export default async function ConnectionsPage({
  ...
  return <main>
    <header className="hero">
      <div>
        <p className="eyebrow">Redrob Work Enterprise</p>
        <h1>Connect incidents</h1>
        <p>Correlate desktop and Den observations for the Redrob Work Cloud MCP connection without email, member identity, URLs, tokens, or customer content.</p>
      </div>
