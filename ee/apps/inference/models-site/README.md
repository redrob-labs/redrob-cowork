...
OpenWork-specific models live in `src/models/openwork-models.json`. `scripts/build-models.mjs` turns that list into the OpenWork provider overlay at build time and switches the provider API URL based on `REDROB_DEV_MODE`.
