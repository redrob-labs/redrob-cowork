...
The Enterprise Mock Lab is a loopback-only development control plane for reusable enterprise simulation packages. Its first module is `@redrob/enterprise-mcp-mock-server`.
