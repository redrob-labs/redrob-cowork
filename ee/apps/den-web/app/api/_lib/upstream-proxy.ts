...
/**
 * Redrob Work Cloud instances are served from Daytona preview origins that are
...
const CORS_ALLOW_HEADERS = "authorization,content-type,x-redrob-org-id,x-redrob-legacy-org-id,x-request-id,accept";
