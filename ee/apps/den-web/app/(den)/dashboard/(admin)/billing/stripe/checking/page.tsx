...
export default function StripeCheckingPage() {
  ...
  // Inference checkouts started from the Redrob Models page carry
        ...
        {failed ? (
          <>
            ...
            <p className="max-w-[480px] text-[14px] leading-6 text-gray-600">
              ...
              <a className="font-medium text-blue-600 hover:underline" href="mailto:team@redrob.io">team@redrob.io</a>.
            </p>
