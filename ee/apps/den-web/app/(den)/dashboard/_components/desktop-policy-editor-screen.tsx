...
function getDisabledPromptCopy(isDefault: boolean) {
  return isDefault
    ? "When organization prompts are off, Redrob Work defaults are used."
    : "When organization prompts are off, members inherit prompts from another matching policy or the default policy; if none apply, Redrob Work defaults are used.";
}
