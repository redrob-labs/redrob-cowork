    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 px-4 py-6" onClick={onClose}>
      ...
      >
        ...
        <p className="mt-1 text-[13px] leading-6 text-gray-600">
          Use one Entra web app for your organization. Each teammate then connects their own work account; Redrob Work requests only the permissions your administrator enables below.
        </p>
          ...
          {configured && !replacingCredentials ? (
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
              ...
              <div className="mt-2 rounded-xl border border-gray-100 bg-white px-3 py-2 text-[12px] text-gray-800">
                Tenant ID: <span className="font-mono">{savedTenantId ?? "stored in Redrob Work"}</span>
              </div>
              <DenButton
                className="mt-3"
                variant="secondary"
