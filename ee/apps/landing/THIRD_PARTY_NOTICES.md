...
These are modified derivative works. Changes by Redrob Work: ported the Astro
markup + inline script to a React component with state-driven feedback,
relabeled the prompt text and copied-feedback copy for Redrob Work, moved the
interaction into the hero prompt block, and applied Redrob Work's ink palette. The
