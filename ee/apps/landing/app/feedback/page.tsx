...
export const metadata = {
  title: "Redrob Work — Feedback",
  description: "Send app feedback to the Redrob Work team with prefilled runtime context.",
  alternates: {
    canonical: "/feedback"
  },
  robots: {
...
export default async function FeedbackPage({ searchParams }: PageProps) {
  ...
  const prefill: AppFeedbackPrefill = {
    source: readSearchParam(resolvedSearchParams, "source") || "redrob-app",
    ...
    redrobServerVersion: readSearchParam(resolvedSearchParams, "redrobServerVersion"),
