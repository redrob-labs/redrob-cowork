...
export const metadata: Metadata = {
  title: "Redrob Work Cloud — the dashboard for your whole org",
  description:
    "Redrob Work Cloud is where you run Redrob Work as a team — provision model providers, deploy skills and MCP servers, manage members and policies. Redrob Work Web and the Connect gateway are built in.",
    ...
    <div className="relative min-h-screen overflow-x-hidden bg-[var(--lp-page)] text-[var(--lp-ink)]">
      <div className="relative z-10">
        ...
        <main className="mx-auto w-full max-w-[1176px] px-6 pb-8">
          <section className="pt-16 md:pt-[88px]">
            <div className="flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div className="max-w-[650px]">
                <div className="mb-5 text-[15px] text-[var(--lp-muted)]">Redrob Work Cloud</div>
          ...
          <section className="mt-[88px]" aria-label="Redrob Work Cloud console preview">
            <LpCloudConsole />
          ...
          <section className="mt-[120px] grid gap-6 lg:grid-cols-3">
            <LpTonalCard className="flex flex-col p-7">
              ...
              <h2 className="mt-8 text-[16.5px] font-semibold">Redrob Work Connect</h2>
            ...
            <LpTonalCard className="flex flex-col p-7">
              ...
              <h2 className="mt-8 flex items-center gap-2 text-[16.5px] font-semibold">Redrob Work Web <LpAlphaBadge /></h2>
            ...
            <LpTonalCard className="flex flex-col p-7">
              ...
              <p className="mt-3 text-[14px] leading-[22px] text-[var(--lp-body)]">Whatever you manage here is exposed over MCP — usable from Redrob Work or any MCP client.</p>
          ...
          <div className="mt-[120px]">
            <LpCta
              heading="Run your org on Redrob Work Cloud."
