...
export const AGENT_START_PROMPT = `Install Redrob Work on my computer, set up my first workspace, and open it ready to use. Follow the steps in https://redrob.io/start.md?v=${PROMPT_VARIANT}`;
...
const steps = ["Installs Redrob Work", "Creates your workspace", "Opens ready to run"];
    ...
    >
      ...
      >
        <div className="mb-2 text-[13px] text-[var(--lp-muted)]">
          Already use an AI agent? Paste this prompt — it installs Redrob Work for you.
        </div>
        <p className="text-[15px] leading-relaxed text-[#011627]">
          Install Redrob Work on my computer, set up my first workspace, and open it
