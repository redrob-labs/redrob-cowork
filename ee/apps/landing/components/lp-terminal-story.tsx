  ...
  if (index === 0) {
    return (
      <div className="text-[#E2E8F0]">
        <span className="text-[#7DD3FC]">❯</span> share my skills and MCPs with my Redrob Work org
      </div>
    );
  }
  if (index === 1) {
      ...
      <div className="self-start overflow-hidden rounded-[24px] bg-[var(--lp-tonal)]">
        <div className="flex h-12 items-center justify-between border-b border-[#e5e7eb] px-5">
          <div className="flex items-center gap-3">
            <TrafficLights />
            <span className="text-[12px] font-medium text-[var(--lp-muted)]">Redrob Work</span>
          </div>
