...
const deployments = [
  ...
  },
  {
    ...
    title: "Self-hosted",
    body: "Run the full Redrob Work stack in your VPC, under your operational controls.",
    icon: Server
  }
];
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto w-full max-w-[1176px] px-6 pb-8">
          <section className="pt-16 md:pt-[88px]">
            <div className="text-[15px] text-[var(--lp-muted)]">Redrob Work Enterprise</div>
            ...
            <p className="mt-7 max-w-[760px] text-[18px] leading-[28px] text-[var(--lp-body)] md:text-[20px] md:leading-[30px]">
              Your models, your infrastructure, your rules. Redrob Work is open source end to end — adopt it for your whole company without handing your AI stack to a vendor.
            </p>
          ...
          <section className="mt-[120px]">
            ...
            <div className="mt-5 flex flex-col gap-4 rounded-[12px] bg-[#0B1E30] px-[22px] py-[18px] sm:flex-row sm:items-center sm:justify-between">
              <code className="mono overflow-x-auto text-[13.5px] text-[#E2E8F0]">$ git clone redrob-labs/redrob-work &amp;&amp; docker compose up</code>
          ...
          <section className="mt-[120px] flex flex-col justify-between gap-8 rounded-[24px] bg-[var(--lp-tonal)] px-7 py-10 md:flex-row md:items-center md:px-12">
            <div className="max-w-[760px]">
              ...
              <p className="mt-3 text-[15px] leading-6 text-[var(--lp-body)]">Central management lives in Redrob Work Cloud — and runs on your private instance too.</p>
            </div>
            <a href="/cloud" className="lp-pill-primary shrink-0">Explore Redrob Work Cloud →</a>
          </section>
