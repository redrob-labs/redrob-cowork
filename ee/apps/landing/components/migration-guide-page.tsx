...
const carryOvers = [
  ["Files and folders", "Open the same folder or repository as an Redrob Work workspace."],
  ["SKILL.md skills", "Copy the skill folder or install the plugin that contains it."],
  ["Claude-compatible plugins", "Import the manifest; Redrob Work normalizes its skills and MCP dependencies."],
  ["MCP servers", "Reconnect through Redrob Work Connect or add the server URL as a custom app."],
  ["Claude models", "Add an Anthropic API key or provision Anthropic through Redrob Work Cloud."],
      ...
      <main className="mx-auto w-full max-w-[1040px] px-6 pb-8">
        <header className="border-b border-[var(--lp-border)] pb-14 pt-16 md:pb-20 md:pt-[88px]">
          ...
          <p className="mt-7 max-w-[720px] text-[18px] leading-[29px] text-[var(--lp-body)]">
            ...
            keep Cowork available until that task works end to end in Redrob Work.
          </p>
        ...
        <section className="py-14 md:py-20">
          ...
          <p className="mt-5 rounded-[14px] bg-[#fff7ed] p-4 text-[13.5px] leading-[22px] text-[#7c2d12]">
            ...
            each connected service in Redrob Work.
          </p>
        </section>
          ...
          <div className="grid gap-12 lg:grid-cols-[260px_minmax(0,1fr)]">
            ...
            <div className="divide-y divide-[var(--lp-border)] border-y border-[var(--lp-border)]">
              <GuideStep number="01" title="Open the same work">
                Install Redrob Work, create a workspace from the folder or repository
              ...
              <GuideStep number="03" title="Bring over skills and plugins">
                Redrob Work uses the same SKILL.md format. Import one skill at a time,
              ...
              <GuideStep number="06" title="Roll it out without configuration drift">
                Use Redrob Work Cloud to publish approved capabilities once, assign them
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-7 flex flex-col items-start gap-3 text-[15px]">
                ...
                <GuideLink href="/docs/cloud/team-quickstart">Redrob Work Cloud team quickstart</GuideLink>
              </div>
            </div>
        ...
        <section className="rounded-[24px] bg-[var(--lp-tonal)] p-7 md:p-12">
          <h2 className="max-w-[620px] text-[34px] font-light leading-[41px] tracking-[-0.015em]">
            Make Redrob Work the default only after the real workflow passes.
          </h2>
