 ...
 *
 * Usage:
 *   pnpm --filter @redrob-ee/den-db db:baseline              # dry run
 *   pnpm --filter @redrob-ee/den-db db:baseline -- --yes     # apply
 *   pnpm --filter @redrob-ee/den-db db:baseline -- --yes --through 0020_breezy_siren
 *
